...
const RewardCard = () => {
    return (
        <View style={{ elevation: 5, width: width / 2 - 30, height: width / 4, backgroundColor: '#ffffff', borderRadius: 7, marginBottom: 20 }}>
            <View style={{
                flexDirection: 'row',
                alignItems: 'center',
                paddingTop: 10,
                ...
                <Image source={require('../../../assets/rewardCoin.png')} style={{ width: width / 15, height: width / 15, }} resizeMode='contain' />
                <View style={{ paddingLeft: 10, zIndex: 5 }}>
                    <Text style={{ color: '#635E5E', fontSize: 20, fontWeight: '700' }}>10<Text style={{ color: '#635E5E', fontSize: 15, fontWeight: '400' }}> Coins</Text></Text>
                    <Text style={{ color: '#635E5E', fontSize: 8, fontWeight: '400' }}>12 Nov 2021</Text>
                </View>
            </View>
            <Text style={{ color: '#635E5E', fontSize: 8, fontWeight: '400', position: 'absolute', bottom: 10, left: 10 }}>BH2908769</Text>
            <Image source={require('../../../assets/rewardGiftImage.png')} style={{ width: width / 5, height: width / 6, position: 'absolute', bottom: 0, right: 10, zIndex: 1 }} resizeMode='contain' />
        </View>
    );
}

export const TrickModal = ({modal,setModal}) =>{
    return( <Modal
        isVisible={modal}
        hasBackdrop={true}
        backdropOpacity={0.3}
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={{ paddingHorizontal: 20, paddingTop: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', alignContent: 'center', }}>
                        <TouchableOpacity onPress={() => { setRewardModal(true) }}>
                            <Image source={require('../../../assets/rewards2.png')} style={{ width: width / 2 - 20, height: width / 3 }} resizeMode='contain' /></TouchableOpacity>
                        <TouchableOpacity onPress={() => { setRewardModal(true) }}>
                            <Image source={require('../../../assets/rewards2.png')} style={{ width: width / 2 - 20, height: width / 3 }} resizeMode='contain' /></TouchableOpacity>
                        <TouchableOpacity onPress={() => { setRewardModal(true) }}>
                           <RewardCard/>
